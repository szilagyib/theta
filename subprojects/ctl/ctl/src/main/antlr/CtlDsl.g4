...
stateFormula
    :   expr
    |   NOT_ stateFormula
    |   stateFormula AND_ stateFormula
    |   stateFormula OR_ stateFormula
    |   stateFormula IMPL_ stateFormula
    |   stateFormula EQ_ stateFormula
    |   EX_ pathFormula
    |   ALL_ pathFormula
    ;
...
pathFormula
    ...
    |   FINALLY stateFormula
    |   NEXT stateFormula
    |   stateFormula UNTIL stateFormula
    |   stateFormula RELEASE stateFormula
    ;
